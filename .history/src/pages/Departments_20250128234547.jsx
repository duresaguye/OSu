          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredDepartments.length > 0 ? (
              filteredDepartments.map(dept => (
                ...
                >
                  <Link to={`/department/${dept.id}`} className="block p-8">
                    <div className="mb-6">
                    ...
                    <div className="flex items-center justify-end">
                      <button className="px-6 py-2 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-colors duration-300 transform hover:scale-105">
                        Explore
                      </button>
                    </div>
                  </Link>
